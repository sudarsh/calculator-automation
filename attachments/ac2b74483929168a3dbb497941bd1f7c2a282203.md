...
- Name: functional/calculator/digit-input.spec.ts >> Digit & operator button mapping >> minus key inserts a minus operator [BUG-002]
- Location: tests/functional/calculator/digit-input.spec.ts:25:8
